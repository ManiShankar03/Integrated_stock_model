...
# Customize ticks and labels to be visible on dark background
...
ax2.bar(quarters_ahead, future_predictions.flatten(), color='lightcoral')  # Light orange color for the bar chart
