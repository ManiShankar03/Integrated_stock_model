...
def plot_next_three_days(selected_date, selected_company):
    ...
    plt.plot(next_three_days_data.index, next_three_days_data['Close'], marker='o', linestyle='-')
    plt.title(f'Stock Prices for {selected_company} for the Next Three Days Starting {selected_date.date()}')
    plt.xlabel('Date')
